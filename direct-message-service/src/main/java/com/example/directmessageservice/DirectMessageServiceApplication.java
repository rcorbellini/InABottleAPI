...
/**
 @Service class DirectMessageListener{

 private DirectMessageRepository directMessageRepository;

 public DirectMessageListener(DirectMessageRepository directMessageRepository) {
 System.out.println("Criando consumer: ");
 this.directMessageRepository = directMessageRepository;
 }

 @RabbitListener(queues = "direct-message-queue")
 public void readMessage(List<DirectMessage> message) {
 System.out.println("New message: " + message);
 directMessageRepository.saveAll(message);
 }
 }
 **/
